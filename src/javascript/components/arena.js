...
export default async function renderArena(selectedFighters) {
    ...
    console.log('Left fighter health bar:', document.getElementById('left-fighter-indicator'));
    console.log('Right fighter health bar:', document.getElementById('right-fighter-indicator'));
